...
class VGG(nn.Module):
    ...
    def loss_init(self):
        ...
        self.obj_loss = loss_counter()
        self.back_loss = loss_counter()
        self.area_loss = loss_counter()
        self.acc_count = acc_counter()

    def loss_count(self,logits,cls_pre,clas):
        self.loss_ct.count(logits[0])
        self.obj_loss.count(logits[1])
        self.back_loss.count(logits[2])
        self.area_loss.count(logits[3])
        self.acc_count = acc_counter()
    ...
    def loss_reset(self):
        self.loss_ct.reset()
        self.obj_loss.reset()
        self.back_loss.reset()
        self.area_loss.reset()
        self.acc_count.reset()

    def loss_output(self):
        output = 'loss:{:.4f},obj_loss:{:.4f},back_loss:{:.4f},area_loss:{:.4f},cls:{:.4f}'\
            .format(self.loss_ct(),self.obj_loss(),self.back_loss(),self.area_loss(),self.acc_count())
        return output
