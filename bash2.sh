...
python U2net_train.py   \
	--gen_devices 0 --seed=6 --record_file=2 \
    ...
    --phase_lis 1   --decay_lis 3000 3000 2500 --n_step_lis 10000 8000 10000 \
	--batch_lis 80 50 60 \
    --steps_per_log=10 --steps_per_weight_save=5000 --steps_per_validation=3000 \
    --model_weight=../weight/result_weight/000004_400_result.pth
